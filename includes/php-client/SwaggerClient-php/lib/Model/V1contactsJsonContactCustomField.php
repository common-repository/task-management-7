<?php
/**
 * V1contactsJsonContactCustomField
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * V1contactsJsonContactCustomField Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1contactsJsonContactCustomField implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1contacts.json_contact_custom_field';
