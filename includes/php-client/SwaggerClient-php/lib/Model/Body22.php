...
class Body22 implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['confirmpassword'] = isset($data['confirmpassword']) ? $data['confirmpassword'] : null;
    ...
    {
        return $this->container['confirmpassword'];
    }
    ...
    {
        $this->container['confirmpassword'] = $confirmpassword;
